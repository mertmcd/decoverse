...
const Sort = ( {sortBrand, sortPrice, sortAscDesc} ) => {
    ...
    return (
        <div className="container mx-auto flex flex-row justify-end ml-5 text-xs">
            <div className="brand flex flex-row ml-5">
                <select value={selected} onChange={handleBrandChange} className="font-custom font-normal border border-gray-400 rounded p-2">
            ...
            <div className="category flex flex-row ml-5">
                <select defaultValue={selected} className="font-custom font-normal border border-gray-400 rounded p-2">
            ...
            <div className="price-interval flex flex-row ml-5">
                <select value={selected} onChange={handlePriceChange} className="font-custom font-normal border border-gray-400 rounded p-2">
            ...
            <div className="price flex flex-row ml-5">
                <select value={selected} onChange={handleAscDescChange} className="font-custom font-normal border border-gray-400 rounded p-2">
